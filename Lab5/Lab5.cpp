...
int main()
{
    ...
    const int SIZE = 6;
    double CS218Final[SIZE] = {98.5, 76, 80.5, 69.5, 87, 57};

    Gradebook CS218gradebook_original;

    for (int i=0; i < SIZE; i++)
    {
        FinalGrade stu_FG(CS218Final[i]);
        CS218gradebook_original.insert(stu_FG);
    }
    ...
    for (int i = 0; i < TESTING_CASES; i++)
    {
        ...
        double diff = expected_avg[i] - CS218gradebook_original.getAverage();
